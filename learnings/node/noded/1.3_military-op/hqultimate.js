...
const report1 = require("./units/intelligence");
console.log("HQ: Received first report.", report1);

console.log("\nHQ: Requesting second intelligence report moments later...");

const report2 = require("./units/intelligence2");
console.log("HQ: Received second report.", report2);


const report3 = require("./units/intelligence3");
console.log("HQ: Received second report.", report3);
